    ...
    with open(fname, "w") as f:
        ...
        f.write(
            "#PBS -l nodes={}:ppn={},walltime={},mem={}mb\n".format(
                params["yeti_sh_ctrl_nodes"],
                params["yeti_sh_ctrl_ppn"],
                params["yeti_sh_ctrl_walltime"],
                params["yeti_sh_ctrl_mem"],
            )
        )
...
def write_shuffling_yeti_script(params):
    ...
    with open(filepath, "w") as f:
        ...
        f.write(
            "#PBS -l nodes={}:ppn={},walltime={},mem={}mb\n".format(
                params["yeti_gen_sh_nodes"],
                params["yeti_gen_sh_ppn"],
                params["yeti_gen_sh_walltime"],
                params["yeti_gen_sh_mem"],
            )
        )
        if params["email_notification"] == "num_jobs":
        ...
        log_folder = "{}/".format(
            os.path.join(params["shuffle_experiment_dir"], "yeti_logs")
        )
    ...
    os.chmod(
        filepath, stat.S_IXUSR | stat.S_IXGRP | stat.S_IXOTH | os.stat(filepath).st_mode
    )
...
def create_yeti_config_sh(params):
    ...
    with open(fname, "w") as f:
        ...
        f.write(
            "#PBS -l nodes={}:ppn={},walltime={},mem={}mb\n".format(
                params["yeti_grid_nodes"],
                params["yeti_grid_ppn"],
                params["yeti_grid_walltime"],
                params["yeti_grid_mem"],
            )
        )
        if params["email_notification"] == "num_jobs":
            # Reduce email notifications for greater numbers of jobs
